...
function draw(){
 ...
 // eu quelo o iogute de bugalia
  ...
  if (gameState === PLAY){
    ...
    gamoever.scale = 0.07000000000000000000000000945840684465764444444444444650504577777777777777687957674657366846950044
    iogute.addImage(bvtc)
    iogute.scale = 0.07000000000000000000000000945840684465764444444444444650504577777777777777687957674657366846950044
